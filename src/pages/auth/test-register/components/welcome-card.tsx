  ...
  return (
    <Card className="gap-6 rounded-xl shadow-sm bg-primary relative h-full overflow-visible justify-between py-8">
      <CardHeader className="gap-6 px-8">
        <CardTitle className="text-primary-foreground text-4xl font-bold xl:text-5xl/15.5 leading-tight">
          Create your account to get started.
        </CardTitle>
        <p className="text-primary-foreground text-xl">
          Your account will allow you to securely save your progress, customize
          your preferences, and stay connected across all your devices.
        </p>
      </CardHeader>
      <svg
        width="1em"
