...
export function WelcomeCard() {
  return (
    <Card className="gap-6 rounded-xl shadow-sm bg-primary relative h-full overflow-visible justify-between py-8 border-none">
      <CardHeader className="gap-6 px-8">
        ...
        <p className="text-primary-foreground text-xl">
          ...
          email, and you'll be back in your account in no time!
        </p>
      </CardHeader>
      ...
      <CardContent className="relative z-1 mx-8 h-62 overflow-hidden rounded-2xl px-0 mt-auto">
        {/* Nested card shape */}
        <svg
          width="1094"
          height="249"
        ...
        >
          <path
            ...
            fill="#1e293b" // Dark background for the inner card
          ></path>
        </svg>

        {/* Floating Brand Icon on inner card */}
